...
- Canonical companion docs: [Roadmap](roadmap.md), [Algorithm Gap Roadmap](algorithm-gap-roadmap.md), [Book Coverage Roadmap](book-coverage-roadmap.md), [Visual Roadmap](visual-roadmap.md), [Visual Content Contract](visual-content-contract.md), [Content Blueprint](content-blueprint.md), [Topic Template](topic-template.md), [Source Map](source-map.md)
