...
- Canonical companion docs: [Content Blueprint](content-blueprint.md), [Topic Template](topic-template.md), [Visual Content Contract](visual-content-contract.md), [Source Map](source-map.md), [Freshness Backbone](freshness-backbone.md), [Expansion Roadmap](expansion-roadmap.md), [Algorithm Gap Roadmap](algorithm-gap-roadmap.md), [Book Coverage Roadmap](book-coverage-roadmap.md), [Visual Roadmap](visual-roadmap.md), [CRT / Lucas / Mobius Wave Plan](crt-lucas-mobius-wave-plan.md)
...
Visual-system planning now lives in [Visual Roadmap](visual-roadmap.md). The content-quality bar for visuals now lives in [Visual Content Contract](visual-content-contract.md).
