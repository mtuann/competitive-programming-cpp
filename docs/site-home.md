...
<div class="home-hero" markdown>
  <p class="hero-kicker">From first prefix sums to contest-ready problem solving</p>
  <p class="hero-copy">
    <strong>competitive-programming-cpp</strong> is a C++ algorithms guide built for people who want a learning path,
    not just a pile of snippets. It combines topic order from strong university courses, practice taste from major
  ...
  <div class="chip-row">
    ...
    <span class="chip">C++ first</span>
    <span class="chip">Contest-ready</span>
    <span class="chip">Theory-backed</span>
  </div>
</div>
