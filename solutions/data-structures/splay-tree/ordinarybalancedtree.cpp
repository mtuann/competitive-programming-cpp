...
struct SplayOrderedMultiset {
    ...
    bool kth_one_based(int k, int& out) {
        return kth_zero_based(k - 1, out);
    }
...
int main() {
    ...
    while (q--) {
        ...
        if (op == 1) {
            ...
            cout << splay.count_less(x) + 1 << '\n';
        } else if (op == 4) {
            int answer = 0;
            splay.kth_one_based(x, answer);
            cout << answer << '\n';
        } else if (op == 5) {
            int answer = 0;
            splay.predecessor(x, answer);
            cout << answer << '\n';
        } else if (op == 6) {
            int answer = 0;
            splay.successor(x, answer);
            cout << answer << '\n';
        }
    }
    return 0;
