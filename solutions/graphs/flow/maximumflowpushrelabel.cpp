// Problem: GRL_6_A - Maximum Flow
// Judge: AOJ
// Source URL: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_6_A
// Topic: Plain directed max flow
// Idea: highest-label push-relabel with gap heuristic on the residual network
