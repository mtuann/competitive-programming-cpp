...
1. write the real live category of each problem:
   ...
   - `close`
   - `park`
2. log the first real leak, not the final embarrassment
3. decide the exact next repo door
4. choose one fresh follow-up rep only after the nearest miss is handled
5. end with one system patch
...
4. finish with one fresh follow-up rep through [Problem Finder](../../docs/problem-finder.md)
