...
- one small regex language with `()`, `|`, `*`, `.`, and full-string membership: [Regex / Finite Automata hot sheet](regex-finite-automata-hot-sheet.md)
