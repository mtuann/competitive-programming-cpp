...
- "old list versions stay alive while new versions are built by merge/head/tail" -> [Persistent Treap hot sheet](persistent-treap-hot-sheet.md)
...
- sequence-persistence sibling -> [Persistent Treap hot sheet](persistent-treap-hot-sheet.md)
...
- split/merge sequence persistence -> [Persistent Treap](../topics/data-structures/persistent-treap/README.md)
