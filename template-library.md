...
| [monotonic-deque-min.cpp](https://github.com/mtuann/competitive-programming-cpp/blob/main/templates/data-structures/monotonic-deque-min.cpp) | sliding minimum or DP over a moving interval | the valid set is not a forward-only window | [Heaps And Ordered Sets](topics/data-structures/heaps-and-ordered-sets/README.md) | no exact repo note yet; reopen the [Sliding Window ladder](practice/ladders/dp/sliding-window/README.md) |
...
| [tree-dp-rerooting.cpp](https://github.com/mtuann/competitive-programming-cpp/blob/main/templates/dp/tree-dp-rerooting.cpp) | every root needs an answer and parent-side contribution matters | the state is not rerootable or you only need one rooted answer | [Tree DP](topics/dp/tree-dp/README.md) | no exact repo note yet; reopen the rerooting section in [Tree DP](topics/dp/tree-dp/README.md) |
...
| [extended-gcd-diophantine.cpp](https://github.com/mtuann/competitive-programming-cpp/blob/main/templates/math/extended-gcd-diophantine.cpp) | need Bezout coefficients, one inverse under composite modulus, or solve `ax + by = c` | prime-mod inverses with many queries are the real task | [Modular Arithmetic](topics/math/modular-arithmetic/README.md) | no exact repo note yet; reopen [Modular Arithmetic](topics/math/modular-arithmetic/README.md) and the [GCD / LCM ladder](practice/ladders/math/gcd-lcm/README.md) |
...
| [ntt.cpp](https://github.com/mtuann/competitive-programming-cpp/blob/main/templates/math/ntt.cpp) | exact convolution modulo `998244353` | modulus is incompatible or convolution is over reals | [FFT / NTT](topics/math/fft-ntt/README.md) | no exact repo note yet; reopen the [FFT ladder](practice/ladders/math/fft/README.md) |
