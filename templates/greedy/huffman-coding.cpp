// Template: Huffman Coding
// Signal: one optimal binary prefix-code tree or one optimal merge process
// from positive symbol frequencies.
// Exposes: build_huffman_codes(frequencies) -> weighted cost + codes.
// Complexity: O(n log n).
// Main trap: this is the coding-tree route, not a full compressor format.
// Links:
//   Topic: topics/greedy/huffman-data-compression/README.md
//   Note: practice/ladders/greedy/huffman-data-compression/huffmancoding.md
...
int main() {
    vector<long long> freq = {45, 13, 12, 16, 9, 5};
